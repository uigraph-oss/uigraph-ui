...
import { Check, GitBranch, Loader2, Lock, Search } from 'lucide-react'
import { useDeferredValue, useState } from 'react'
import { OnboardingShell, StepIntro } from './onboarding-shell'
import { RepositoryCard } from './visuals/repository-card'
...
export function SelectRepositoryStep({
  ...
  return (
    <OnboardingShell
      ...
      aside={<RepositoryCard repository={selected} />}
    >
      <StepIntro
        eyebrow="Repository"
      ...
      <div className="border-stock mt-3 flex h-[22rem] flex-col overflow-hidden rounded-2xl border">
            ...
            {visibleRepositories.map((repository) => (
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="text-paragraph mt-1 flex items-center gap-1.5 font-mono text-[0.6875rem]">
