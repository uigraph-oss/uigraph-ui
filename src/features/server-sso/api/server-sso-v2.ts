...
export const OAUTH_PROVIDERS_V2 = graphql(`
...
export const UPSERT_OAUTH_PROVIDER_V2 = graphql(`
...
export const SAML_STATUS_V2 = graphql(`
  query SamlStatusV2 {
    saml {
      id
    }
