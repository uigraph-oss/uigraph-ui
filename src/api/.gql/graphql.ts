...
export type MlStudioProjectsQuery = { mlProjects: Array<{ id: string, name: string, type: string, description: string, sourceType: string, sourceUrl: string, teamId?: string | null }> };
