...
export type MlStudioExperimentsQuery = { mlExperiments: Array<{ id: string, projectId?: string | null, name: string, description: string, status: string, startedAt?: string | null, source: string }> };
