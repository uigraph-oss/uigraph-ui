...
export type MlVersionEvaluationsQuery = { mlVersionEvaluations: Array<{ id: string, versionId: string, datasetId?: string | null, name: string, type: string, description: string, summary: string, evaluatedAt?: string | null, evaluator: string, parameters: unknown, metrics: unknown }> };
...
export type MlEvaluationQuery = { mlEvaluation: { id: string, versionId: string, datasetId?: string | null, name: string, type: string, description: string, summary: string, evaluatedAt?: string | null, evaluator: string, parameters: unknown, metrics: unknown } };
