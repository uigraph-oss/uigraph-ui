...
export type ChatSessionQuery = { chatSession: { session: { id: string, orgId: string, ownerUserId: string, title: string, isPinned: boolean, messageCount: number, createdAt: string, updatedAt: string }, messages: Array<{ id: string, chatSessionId: string, role: string, content: string, createdAt: string }> } };
