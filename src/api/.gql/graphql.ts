...
export type MlStudioProjectsQuery = { mlProjects: Array<{ id: string, name: string, type: string, description: string, sourceType: string, sourceUrl: string, team: string, email: string }> };
...
export type MlStudioProjectQuery = { mlProject: { id: string, name: string, type: string, description: string, sourceType: string, sourceUrl: string, team: string, email: string } };
...
export type MlStudioRunQuery = { mlRun: { id: string, experimentId: string, name: string, status: string, startedAt?: string | null, endedAt?: string | null, duration: string, notes: string, parameters: unknown, metrics: unknown, datasetId?: string | null, series: unknown } };
...
export type MlStudioExperimentRunsQuery = { mlRuns: Array<{ id: string, experimentId: string, name: string, status: string, startedAt?: string | null, endedAt?: string | null, duration: string, notes: string, parameters: unknown, metrics: unknown, datasetId?: string | null, series: unknown }> };
...
export type MlStudioRunArtifactsQuery = { mlArtifacts: Array<{ id: string, runId: string, name: string, type: string, uri: string, size: string, format: string }> };
