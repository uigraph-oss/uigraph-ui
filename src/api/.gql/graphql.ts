...
export type MlVersionEvaluationsQuery = { mlVersionEvaluations: Array<{ id: string, versionId: string, experimentId: string, modelName: string, version: string, datasetId?: string | null, name: string, type: string, description: string, summary: string, evaluatedAt?: string | null, evaluator: string, createdBy?: string | null, parameters: unknown, metrics: unknown }> };
...
export type MlEvaluationQuery = { mlEvaluation: { id: string, versionId: string, experimentId: string, modelName: string, version: string, datasetId?: string | null, name: string, type: string, description: string, summary: string, evaluatedAt?: string | null, evaluator: string, createdBy?: string | null, parameters: unknown, metrics: unknown } };
...
export type MlStudioFindingsQuery = { mlFindings: Array<{ id: string, modelId: string, versionId?: string | null, title: string, summary: string, description: string, runIds: Array<string>, createdAt?: string | null, createdByActor?: { id: string, name: string } | null }> };
