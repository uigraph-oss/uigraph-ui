...
export type CostSavingsByUserQuery = { costSavingsByUser: Array<{ userId?: string | null, serviceAccountId?: string | null, displayName: string, totalCalls: number, tokensSaved: number, costSavedUsd: number, totalDurationMs: number }> };
