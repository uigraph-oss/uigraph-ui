...
export type RepositoryOnboarding = {
  artifactsPullRequestUrl?: Maybe<Scalars['String']['output']>;
  error?: Maybe<Scalars['String']['output']>;
  generationRunUrl?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  missingAIConfiguration: Array<Scalars['String']['output']>;
  repository: GitHubRepository;
  serviceId?: Maybe<Scalars['ID']['output']>;
  setupPullRequestUrl?: Maybe<Scalars['String']['output']>;
  status: RepositoryOnboardingStatus;
  syncRunUrl?: Maybe<Scalars['String']['output']>;
};
...
export enum RepositoryOnboardingStatus {
  ArtifactsPrOpen = 'ARTIFACTS_PR_OPEN',
  Cancelled = 'CANCELLED',
  CheckingAiConfiguration = 'CHECKING_AI_CONFIGURATION',
  Completed = 'COMPLETED',
  Failed = 'FAILED',
  GenerationQueued = 'GENERATION_QUEUED',
  GenerationRunning = 'GENERATION_RUNNING',
  Running = 'RUNNING',
  Selected = 'SELECTED',
  SetupPrCreating = 'SETUP_PR_CREATING',
  SetupPrOpen = 'SETUP_PR_OPEN',
  SyncQueued = 'SYNC_QUEUED',
  SyncRunning = 'SYNC_RUNNING',
  WaitingAiConfiguration = 'WAITING_AI_CONFIGURATION',
  WaitingArtifactsMerge = 'WAITING_ARTIFACTS_MERGE',
  WaitingSetupMerge = 'WAITING_SETUP_MERGE'
}
...
export type OnboardingRepositoryOnboardingQuery = { repositoryOnboarding: { id: string, status: RepositoryOnboardingStatus, teamId: string, teamName?: string | null, repositories: Array<{ id: string, status: RepositoryOnboardingStatus, setupPullRequestUrl?: string | null, generationRunUrl?: string | null, artifactsPullRequestUrl?: string | null, syncRunUrl?: string | null, missingAIConfiguration: Array<string>, error?: string | null, serviceId?: string | null, repository: { id: string, githubId: string, name: string, fullName: string, url: string, defaultBranch: string, private: boolean, archived: boolean } }> } };
