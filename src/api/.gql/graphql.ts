...
export type Query = {
  ...
  serviceStats: Array<ServiceStats>;
...
export type DiagramsQuery = { diagrams: { totalCount: number, items: Array<{ id: string, orgId: string, folderId?: string | null, teamId?: string | null, name: string, previewAssetId?: string | null, previewImageUrl?: string | null, previewContentHash?: string | null, previewStatus: string, createdBy: string, updatedBy?: string | null, createdAt: string, updatedAt: string, createdByActor?: { id: string, type: string, name: string, email?: string | null, avatarUrl?: string | null } | null, updatedByActor?: { id: string, type: string, name: string, email?: string | null, avatarUrl?: string | null } | null }> } };
...
export type CostSavingsSummaryQuery = { costSavingsSummary: { orgId: string, period: string, modelId?: string | null, totalCalls: number, totalTokensServed: number, totalTokensSaved: number, costServedUsd: number, costRawUsd: number, costSavedUsd: number, uniqueUsersCount: number } };
...
export type CostSavingsTimeseriesQuery = { costSavingsTimeseries: Array<{ date: string, totalCalls: number, totalTokensServed: number, totalTokensSaved: number, costServedUsd: number, costRawUsd: number, costSavedUsd: number }> };
...
export type CostSavingsByToolQuery = { costSavingsByTool: Array<{ toolName: string, totalCalls: number, tokensSaved: number, costSavedUsd: number }> };
...
export type CostSavingsByModelQuery = { costSavingsByModel: Array<{ modelId: string, displayName: string, provider: string, totalCalls: number, tokensSaved: number, costSavedUsd: number }> };
...
export type CostSavingsByUserQuery = { costSavingsByUser: Array<{ userId?: string | null, serviceAccountId?: string | null, displayName: string, totalCalls: number, tokensSaved: number, costSavedUsd: number }> };
...
export type MembersQuery = { members: Array<{ userId: string, email: string, name: string, role: string, teamId?: string | null }> };
...
export type ApiEndpointByIdQuery = { apiEndpointById: { id: string, serviceId: string, apiGroupId: string } };
...
export type TestPackByIdQuery = { testPackById: { testPackId: string, serviceId: string } };
...
export type ServerUsersQuery = { users: Array<{ id: string, email: string, name: string, login: string, disabled: boolean, role: string, lastSeenAt?: string | null, createdAt: string, updatedAt: string }> };
...
export type ServiceDBsQuery = { serviceDBs: Array<{ id: string, serviceId: string, orgId: string, dbName: string, dbType: string, dialect: string, noSQLSchema?: unknown | null, dbDiagramId?: string | null, pgDumpFileId?: string | null, source?: string | null, sourceTs?: string | null, createdBy: string, updatedBy?: string | null, createdAt: string, updatedAt: string, tables: Array<{ name?: string | null, columns?: Array<{ name?: string | null, type?: string | null, nullable?: boolean | null, isPrimaryKey?: boolean | null, unique?: boolean | null, autoIncrement?: boolean | null, defaultValue?: string | null, foreignKey?: string | null, description?: string | null }> | null, indexes?: Array<{ name?: string | null, type?: string | null, fields?: Array<string> | null }> | null }>, createdByActor?: { id: string, name: string, avatarUrl?: string | null } | null, updatedByActor?: { id: string, name: string, avatarUrl?: string | null } | null }> };
...
export type ServiceDiagramsQuery = { serviceDiagrams: Array<{ serviceId: string, diagramId: string, orgId: string, createdBy: string, updatedBy?: string | null, createdAt: string, updatedAt: string, diagram?: { id: string, orgId: string, name: string, previewAssetId?: string | null, previewImageUrl?: string | null, previewContentHash?: string | null, createdAt: string, updatedAt: string, createdByActor?: { id: string, name: string, avatarUrl?: string | null } | null, updatedByActor?: { id: string, name: string, avatarUrl?: string | null } | null } | null }> };
...
export type ServiceStatsQuery = { serviceStats: Array<{ serviceId: string, endpointCount: number, diagramCount: number, dbTableCount: number, docCount: number, testCaseCount: number }> };
...
export type MeAndOrgBootstrapQuery = { me: { userId: string, email: string, name: string, avatarUrl?: string | null, isServerAdmin: boolean }, myOrgs: Array<{ id: string, name: string, role: string, logoUrl?: string | null }> };
...
export const ServiceStatsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ServiceStats"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"orgId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"serviceId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"serviceStats"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"orgId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"orgId"}}},{"kind":"Argument","name":{"kind":"Name","value":"serviceId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"serviceId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"serviceId"}},{"kind":"Field","name":{"kind":"Name","value":"endpointCount"}},{"kind":"Field","name":{"kind":"Name","value":"diagramCount"}},{"kind":"Field","name":{"kind":"Name","value":"dbTableCount"}},{"kind":"Field","name":{"kind":"Name","value":"docCount"}},{"kind":"Field","name":{"kind":"Name","value":"testCaseCount"}}]}}]}}]} as unknown as DocumentNode<ServiceStatsQuery, ServiceStatsQueryVariables>;
