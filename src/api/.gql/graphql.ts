...
export type UpdateMlModelMutation = { updateMlModel: { id: string, domain: string, problemType: string, license: string, references: Array<string>, intendedUse: string, limitations: string, ethicalConsiderations: string, caveats: string } };
