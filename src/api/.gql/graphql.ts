...
export type ServiceDependencyGraphQuery = { serviceDependencyGraph: { nodes: Array<{ id: string, name: string, onboardingStatus?: string | null, service?: { id: string, description?: string | null, gitRepoUrl?: string | null, updatedAt?: string | null } | null }>, edges: Array<{ id: string, source: string, target: string, type?: string | null, criticality?: string | null, operations?: unknown | null }> } };
